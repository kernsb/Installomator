...
snagit2025)
    name="Snagit"
    type="dmg"
    sparkleData=$(curl -fsL -H 'User-Agent: Snagit/2025.0.0 Sparkle/2.8.0' 'https://www.techsmith.com/redirect.asp?target=sparkleappcast&product=snagitmac&ver=2025.4.0&lang=enu&os=mac')
    appNewVersion=$(
        echo "$sparkleData" | \
...
snagit2021)
    name="Snagit 2021"
    type="dmg"
    sparkleData=$(curl -fsL -H 'User-Agent: Snagit/2021.0.0 Sparkle/2.8.0' 'https://www.techsmith.com/redirect.asp?target=sufeedurl&product=snagitmac&ver=2021.0.0&lang=enu&os=mac')
    appNewVersion=$(
        echo "$sparkleData" | \
        xmllint -xpath 'string(//*[local-name()="item"][1]/title/text())' - | \
        awk '{ print $2 }'
...
snagit2022)
    name="Snagit 2022"
    type="dmg"
    sparkleData=$(curl -fsL -H 'User-Agent: Snagit/2022.0.0 Sparkle/2.8.0' 'https://www.techsmith.com/redirect.asp?target=sufeedurl&product=snagitmac&ver=2022.0.0&lang=enu&os=mac')
    appNewVersion=$(
        echo "$sparkleData" | \
        xmllint -xpath 'string(//*[local-name()="item"][last()]/*[local-name()="shortVersionString"]/text())' -
    )
...
snagit2023)
    name="Snagit 2023"
    type="dmg"
    sparkleData=$(curl -fsL -H 'User-Agent: Snagit/2023.0.0 Sparkle/2.8.0' 'https://www.techsmith.com/redirect.asp?target=sufeedurl&product=snagitmac&ver=2023.0.0&lang=enu&os=mac')
    appNewVersion=$(
        echo "$sparkleData" | \
        xmllint -xpath 'string(//*[local-name()="item"][last()]/*[local-name()="shortVersionString"]/text())' -
    )
...
snagit2024)
    name="Snagit"
    type="dmg"
    sparkleData=$(curl -fsL -H 'User-Agent: Snagit/2024.0.0 Sparkle/2.8.0' 'https://www.techsmith.com/redirect.asp?target=sufeedurl&product=snagitmac&ver=2024.0.0&lang=enu&os=mac')
    appNewVersion=$(
        echo "$sparkleData" | \
        xmllint -xpath 'string(//*[local-name()="item"][last()]/*[local-name()="shortVersionString"]/text())' -
    )
